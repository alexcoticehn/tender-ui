  ...
  return (
    <div className="min-h-screen text-gray-900 font-serif">
        ...
        <section className="max-w-5xl mx-auto mt-12 px-4">
          <h2 className="text-6xl mb-4 font-serif text-center mx-auto">Meet Megan</h2>
          <div className="grid md:grid-cols-6 mx-auto gap-6">
            <div className="md:col-span-2 flex items-center justify-center">
              <Image src="/images/megan-headshot.webp" alt="Megan headshot" width={500} height={500} className="object-cover w-full" />
            </div>
            <div className="flex flex-col justify-center font-serif md:col-start-4 md:col-span-3 mx-auto">
