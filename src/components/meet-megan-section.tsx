  ...
  return (
    <section className="w-full py-16 md:py-24 px-4 md:px-6 lg:px-10">
      <div className="max-w-5xl mx-auto">
        <h1 className="md:text-6xl mb-8 text-center">Meet Megan</h1>
        <div className="grid md:grid-cols-6 gap-8 md:gap-6">
          ...
          <div className="flex flex-col justify-center md:col-start-4 md:col-span-3">
            ...
            <p>I identify as queer and genderqueer, and I&apos;m committed to creating a space where all identities are welcome.</p>
          </div>
        </div>
      </div>
    </section>
